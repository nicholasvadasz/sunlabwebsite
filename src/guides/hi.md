...
As of June 2021 we no longer use password authentication, except for first-time users and users who have recently changed their passwords. You will need to upload public keys for each device you wish to use to connect to the CS department. You can upload keys from your CS website profile page. After uploading your key, you will receive an email confirmation for the upload. You must reply to the email confirmation in order to actiavate your new key on the ssh gateway.
